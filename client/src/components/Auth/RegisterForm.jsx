    ...
    <div className="w-full max-w-md mx-auto">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Crea tu cuenta y comienza a jugar</p>
        </div>
        ...
        <div className="text-center">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ¿Ya tienes cuenta?{' '}
            <a href="#" className="text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300 font-medium transition-colors duration-200">
              Inicia sesión aquí
            </a>
          </p>
        </div>
