    ...
    return (
      <div className="flex-1 flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="text-center max-w-sm">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Selecciona un chat</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">Elige un contacto para chatear</p>
        </div>
      </div>
    );
  }
